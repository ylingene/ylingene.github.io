      ...
      <span className={navigationSubNav}>
        ...
        <div className={navigationSubContainer}>
          <div className={navigationSubLinks}>
            <NavLink to={PHOTOGRAPHY_PATH} isSubNav={true}>Gallery</NavLink>
            <NavLink to={COLLECTIONS_PATH} isSubNav={true} partiallyActive={true}>Collections</NavLink>
          </div>
        </div>
      </span>
      {/*
...
const isActive = (baseStyles, allStyles, path) => ({ isCurrent, location }) => {
  ...
  const appliedStyles = isCurrent || isPartiallyActive ? allStyles : baseStyles
  return { className: appliedStyles }
}

const MobileNavLink = ({ children, checkIsActive = false, isSubLink = false, to, ...props }) => {
  ...
  */
  const linkGetProps = checkIsActive ? isActive(baseStyles, combinedStyles, to) : undefined
  return (
    <Link
  ...
  return (
    <div className={wrapperMobile}>
      <div className={mobileNavBar}>
        ...
        <button className={mobileMenuButton} onClick={() => setIsOpen(!isOpen)}>
          {!isOpen ? 
      ...
      { isOpen && 
        <div className={mobileMenu}>
          ...
          <div className={mobileSocial}><Instagram /></div>
